...
#ifndef _USER_CONFIG_OVERRIDE_H_FLUR_
#define _USER_CONFIG_OVERRIDE_H_FLUR_
...
*/
  ...
  #define USER_TEMPLATE "{\"NAME\":\"Flur-Deckenlampe\",\"GPIO\":[1,1,1,1,640,608,1,1,1,1,1,1,1,1],\"FLAG\":0,\"BASE\":18}"  // [Template] Set JSON template
// Flur
...
#endif  // _USER_CONFIG_OVERRIDE_H_FLUR_
